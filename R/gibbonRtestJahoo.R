...
JahooMFCCDFCrested <- MFCCFunction(input.dir='/Volumes/DJC Files/MultiSpeciesTransferLearning/TrainingDataWavs/CombinedClipsBirdNET/CrestedGibbons',
                            min.freq = 400,
                            max.freq = 3000,
                            n.windows = 9,
                            num.cep = 12,
...
JahooMFCCDFGrey<- MFCCFunction(input.dir='/Volumes/DJC Files/MultiSpeciesTransferLearning/TrainingDataWavs/CombinedClipsBirdNET/GreyGibbons',
                                   min.freq = 400,
                                   max.freq = 3000,
                                   n.windows = 9,
                                   num.cep = 12,
...
JahooMFCCDFNoise <- MFCCFunction(input.dir='/Volumes/DJC Files/MultiSpeciesTransferLearning/TrainingDataWavs/CombinedClipsBirdNET/noise',
                                 min.freq = 400,
                                 max.freq = 3000,
                                 n.windows = 9,
                                 num.cep = 12,
